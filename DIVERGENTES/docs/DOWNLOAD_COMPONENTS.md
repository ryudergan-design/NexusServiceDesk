...
- Criar uma documentação unificada no repositório descrevendo como utilizá-los no projeto (ex: `SITE/docs/UI_CATALOG.md`).
...
3. **Catálogo de Componentes**:
   Escrever o arquivo `SITE/docs/UI_CATALOG.md` contendo a lista dos componentes, suas funcionalidades (ex: *Chart* para Dashboards analiticos, *Input OTP* para verificacao de 2 fatores) e exemplos praticos para rapida adocao nas Fases 4, 5, etc.
